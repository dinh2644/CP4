...
# Test-case 1 : Remove the added songs and then call favorite (WORKS!!!!!!!!!!!!!!!!!!!!!!!!)
tests[1]="
...
# Test-case 2 : Listen, favorite, and show listen time (WORKS!!!!!!!!!!!!!!!!!!!!!!!!))
tests[2]="
...
# Test-case 3 : Try listening to a favorited song, which will be ignored (WORKS!!!!!!!!!!!!!!!!!!!!!!!!))
tests[3]="
song 1 Taylor 330 Ruby
listen Ruby 100
favorite
...
# Test-case 4 : Remove a favorited and non-favorited song (WORKS!!!!!!!!!!!!!!!!!!!!!!!!))
tests[4]="
song 1 Taylor 330 Ruby
song 2 Test 440 Emarald
listen Ruby 100
...
# Test-case 5 : Listen to songs, remove a subset, and favorite (SEG FAULT - right before command 18)
tests[5]="
